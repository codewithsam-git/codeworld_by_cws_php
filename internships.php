...
if ($conn->connect_error) {l
    die("Connection failed: " . $conn->connect_error);
}              
        $stmt = $conn->prepare("INSERT INTO internships (on_title, on_fees, on_start_date, on_end_date, on_description ,on_image, on_image_path) VALUES (?, ?, ?, ?, ?, ?, ?)");
