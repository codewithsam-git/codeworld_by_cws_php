...
if ($conn->connect_error) {
    ...
    $sql = "SELECT * FROM offline_courses";
...
if ($conn->connect_error) {
    die("Connection failed: " . $conn->connect_error);
        ...
        $stmt = $conn->prepare("INSERT INTO offline_courses (off_title, off_fees, off_duration, off_description ,off_image, off_image_path) VALUES (?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("ssssss", $offTitle, $offFees, $offDuration, $offDescription, $filename, $imagePath);
